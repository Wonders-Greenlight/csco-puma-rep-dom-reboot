...
class Server {
    ...
    setup() {
        ...
        this.app.get(this.shopify.config.auth.callbackPath, this.shopify.auth.callback(), this.shopify.redirectToShopifyOrAppRoot());
        this.app.use(express.json());
        this.app.use(cookieParser());
        this.createRoutes();
        this.app.use(serveStatic(this.STATIC_PATH, { index: false }));
        this.app.use('/*', rootCheckAndRedirect, serveClientApp);
    }
    createRoutes() {
