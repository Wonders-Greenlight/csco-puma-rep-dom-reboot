...
// REST RESOURCES
import { Customer } from '@shopify/shopify-api/rest/admin/2023-07/customer';
...
import { Order } from '@shopify/shopify-api/rest/admin/2023-07/order';
import { Metafield } from '@shopify/shopify-api/rest/admin/2023-07/metafield';
import { CarrierService } from '@shopify/shopify-api/rest/admin/2023-07/carrier_service';
import { Transaction as ShopifyTransaction } from '@shopify/shopify-api/rest/admin/2023-07/transaction';
import { Webhook as ShopifyWebhook } from '@shopify/shopify-api/rest/admin/2023-07/webhook';
import { Location as ShopifyLocation } from '@shopify/shopify-api/rest/admin/2023-07/location';
import { FulfillmentOrder } from '@shopify/shopify-api/rest/admin/2023-07/fulfillment_order';
import { Fulfillment as ShopifyFulfillment } from '@shopify/shopify-api/rest/admin/2023-07/fulfillment';

export enum IFulfillmentEvent {
    ...
    PICKED_UP = 'picked_up',
    CONFIRMED = 'confirmed',
    PREPARED = 'prepared', // DEPRECATED => CONFIRMED
...
export type GqlMetafieldType = 'boolean' | 'color' | 'date' | 'date_time' | 'dimension' | 'json' |
    ...
    'list.single_line_text_field' | 'single_line_text_field' | 'url' | 'volume' | 'weight' | 'product_reference' | 'page_reference' | 'variant_reference' | 'mixed_reference' | 'metaobject_reference' |
    'file_reference' | 'collection_reference' | 'list.product_reference' | 'list.page_reference' | 'list.variant_reference' | 'list.mixed_reference' | 'list.metaobject_reference' |
    'list.file_reference' | 'list.collection_reference'
...
export type WeightUnits = ObjectValues<typeof GqlWeightUnit>
...
export type MediaContentTypes = ObjectValues<typeof GqlMediaContentType>
...
export interface CreateCarrierServiceParams {
    name:               string;
    callback_url:       string;
    service_discovery:  boolean;
}

export interface GqlMediaInput {
    alt?:               string;
...
export interface CreateFulfillmentParams {
    ...
    line_items_by_fulfillment_order: {
        fulfillment_order_id: any;
    }[];
    shipment_status: IFulfillmentEvent;
    message: string;
}

export interface CreateFulfillmentEventParams {
    order_id: any;
    fulfillment_id: any;
    status: IFulfillmentEvent;
}